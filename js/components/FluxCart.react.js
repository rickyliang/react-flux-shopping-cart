...
var FluxCart = React.createClass({
    ...
    // Remove item from cart via Action
    ...
    render: function() {
        ...
        return (
            <div className={"flux-cart " + (this.props.visible ? 'active' : '')}>
                        ...
                        {Object.keys(products).map(function(product) {
                            return (
                                <li key={product}>
                                    ...
                                    <button type="button" className="remove-item" onClick={self.removeFromCart.bind(self, product)}>
                                        Remove
                                    </button>
                                </li>
                            )
                ...
                <button type="button" className="view-cart" onClick={this.openCart} disabled={Object.keys(this.props.products).length > 0 ? '' : 'disabled'}>
                    View Cart
                </button>
            </div>
        );
